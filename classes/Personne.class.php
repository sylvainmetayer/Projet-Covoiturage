	...
	public function affecte($donnees)
	{
		...
		foreach ($donnees as $attribut => $valeurs)
		{
			switch ($attribut)
			{
				...
				case 'per_nom' : $this->setNomPersonne($valeurs); break;
				case 'per_prenom' : $this->setPrenomPersonne($valeurs); break;
				case 'per_tel' : $this->setPerTel($valeurs); break;
				case 'per_mail' : $this->setPerMail($valeurs); break;
				case 'per_login' : $this->setPerLogin($valeurs); break;
				case 'per_pwd' : $this->setPerPwd($valeurs); break;
			}
		}
	}
