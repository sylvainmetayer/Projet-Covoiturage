...
class PersonneManager {
	...
	// Cette fonction va ajouter une personne, puis retourner l'id de la personne ajout̩, ce qui permettra de faire l'ajout de l'̩tudiant/salari̩
	// A TESTER
	public function add($personne) {
		...
		// Pour ajouter par la suite un etudiant/salari̩
	}
