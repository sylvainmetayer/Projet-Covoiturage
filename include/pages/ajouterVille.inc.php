...
<p> Nom :
<input type='text' placeholder='Ex : Bordeaux' name='choix_ville'>
...
else
{
	...
	if ($retour != 0) //OK
	{
		...
		La ville <b><?php echo $_POST['choix_ville'] ?></b> a été ajoutée 
		</p>
	<?php
	}
	else
	{
		...
		La ville <b><?php echo $_POST['choix_ville'] ?></b> n'a pas été ajoutée 
		</p>
	<?php 
	}
}
