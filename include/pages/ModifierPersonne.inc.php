...
} else if (empty ( $_POST ['per_tel'] )) 
{
	...
	<form action="#" method="POST">
			...
			<br />
			T�l�phone : <input name='per_tel' id='per_tel' type='text' value='<?php echo $personne->getPerTel(); ?>' required/> 
			<br /> 
			...
			<br />
			<!-- On saisie deux fois afin d'�tre sur que la saisie du nouveau mot de passe est correcte --> 
