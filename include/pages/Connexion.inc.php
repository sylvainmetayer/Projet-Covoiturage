...
<form action="#" method="post">
		...
		<br/>
		<p> 
		Merci de r�soudre le calcul suivant pour confirmer que vous n'�tes pas un robot <br/>
		<?php echo "$nb1+$nb2 = ?"; ?>
		</p>
...
} else 
{
	...
	$reponse = $_POST['reponse']; //r�ponse de l'utilsateur
	...
	if ( ($connexionOK == $resultat) && ($connexionOK == true) ) //le captcha est bon et les id/mdp aussi
	{
		...
		// Probleme, etant donn� que c'est un objet
		// TODO
