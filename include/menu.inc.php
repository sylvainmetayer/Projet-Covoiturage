<div id="menu">
	<div id="menuInt">
		<p>
			<a href="index.php?page=0"><img src="image/accueil.gif"
				class="imagMenu" alt="Accueil" />Accueil</a>
		</p>
		<p>
			<img src="image/personne.png" class="imagMenu" alt="Personne" />Personne
		</p>
		<ul>
		...
		<p>
			<img src="image/parcours.gif" class="imagMenu" alt="Parcours" />Parcours
		</p>
		<ul>
		...
		<p>
			<img src="image/ville.png" class="imagMenu" alt="Ville" />Ville
		</p>
		<ul>
			<li><a href="index.php?page=7">Ajouter</a></li>
			<li><a href="index.php?page=8">Lister</a></li>
		</ul>
		<?php if (!empty($_SESSION['per_login_connecte'])) { //la personne est connectee ?>
		<p>
